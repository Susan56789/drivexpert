                ...
                <div
                    ...
                    <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                        <a
                            ...
                            <img src="/assets/images/logo2.png" alt="drivexpert-logo" />
                        </a>
                        <p class="mt-2 text-sm text-gray-500"> Satisfaction Driven, Expertly Delivered.</p>
                        <div class="mt-4">
                    ...
                    <div class="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                        <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                            ...
                            <nav class="mb-10 list-none">
                                ...
                                <li class="mt-3">
                                    <a href="/sell-car" class="text-gray-500 cursor-pointer hover:text-gray-900">Sell
                                        Your Car</a>
                                </li>
                            </nav>
                        </div>
                        ...
                        <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                            ...
                            <nav class="mb-10 list-none">
                                ...
                                <li class="mt-3">
                                    <a class="text-gray-500 cursor-pointer hover:text-gray-900">+254 739 456 722</a>
                                </li>
                            </nav>
                        </div>
                    </div>
