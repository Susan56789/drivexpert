    ...
    module.exports = (client, app, authenticate, ObjectId, upload) => {
        ...
        app.post('/api/cars', authenticate, upload.array('images', 10), async (req, res) => {
            try {
                ...
                const { carName, fuelType,
                    engineSize, mileage, price, year,
                    currentLocation, description, transmission,
                    condition } = req.body;
                const carData = {
                    carName, fuelType, engineSize,
                    mileage, price, year, currentLocation,
                    description, transmission, condition
                };
